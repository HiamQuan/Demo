...
const Footer = {
  print() {
    return /* html */ `  <footer class="text-gray-600 body-font bg-gray-700">
    <div class="container mt-10 px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
      <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
        <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
          ...
          <span class="ml-3 text-xl text-white">GrandMaster</span>
        </a>
        <p class="mt-2 text-sm text-white">Nguyễn Anh Quân_PH18209</p>
      </div>
